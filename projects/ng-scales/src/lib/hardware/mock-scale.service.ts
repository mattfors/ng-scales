...
import { HARDWARE_SCALE_INTERFACE, HardwareScaleInterface, HardwareScaleReportEvent } from './hardware-scale.interface';
...
export class MockScaleService implements HardwareScaleInterface {
  ...
  _report: Subject<HardwareScaleReportEvent> = new Subject<HardwareScaleReportEvent>();
